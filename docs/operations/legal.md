...
例: [ADR-008 cookie consent banner](./log/2026-02-16-cookie-consent-banner.md)、[ADR-009 cookie consent required](./log/2026-02-18-cookie-consent-required.md) は過去の cookie 同意まわりの意思決定記録（このディレクトリ新設以前のもの）。
