...
| GitHub Secrets                         | 各 entry（[Environment Secrets](./security/environment-secrets.md) §GitHub の表） | 無し（双方向 drift は [#2090](https://github.com/Dayopt/dayopt/issues/2090) で解消中）                 |
