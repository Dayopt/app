...
#### モバイルUI全面刷新 ([#1017](https://github.com/Dayopt/dayopt/pull/1017))
...
#### カレンダー機能強化 ([#1017](https://github.com/Dayopt/dayopt/pull/1017))
...
#### タグアイコン機能 ([#1017](https://github.com/Dayopt/dayopt/pull/1017))
...
#### メールi18n対応 ([#1022](https://github.com/Dayopt/dayopt/pull/1022))
...
#### 通知機能の強化 ([#1022](https://github.com/Dayopt/dayopt/pull/1022))
...
#### iCalフィードのレート制限 ([#1017](https://github.com/Dayopt/dayopt/pull/1017))

- レート制限をUpstash Redisに移行（Supabase依存から脱却）

#### i18n CI整合性チェック ([#1017](https://github.com/Dayopt/dayopt/pull/1017))

- `lint:i18n` — 全ロケール間の翻訳キー整合性チェックをCIに追加
- 新言語追加スクリプト

#### Storybook Docs全面刷新 ([#1022](https://github.com/Dayopt/dayopt/pull/1022))
...
#### Chronotype機能リデザイン ([#1022](https://github.com/Dayopt/dayopt/pull/1022))
...
#### カレンダー内部アーキテクチャ統一 ([#1017](https://github.com/Dayopt/dayopt/pull/1017))
...
#### デザイントークン体系の刷新 ([#1022](https://github.com/Dayopt/dayopt/pull/1022))
...
#### タイムゾーン対応の全面修正 ([#1022](https://github.com/Dayopt/dayopt/pull/1022))
...
#### plan/record → entry 用語統一 ([#1022](https://github.com/Dayopt/dayopt/pull/1022))
...
#### シェル・ヘッダー整理 ([#1017](https://github.com/Dayopt/dayopt/pull/1017))
...
#### 設定画面リデザイン ([#1017](https://github.com/Dayopt/dayopt/pull/1017))

- `SectionCard` / `LabeledRow` コンポーネントをリデザイン
- 全設定ページにリデザインコンポーネントを適用
- モバイル設定ルートのハイドレーション後ガード追加

#### Zustand Store統合 ([#1022](https://github.com/Dayopt/dayopt/pull/1022))
...
#### スタイル最適化 ([#1022](https://github.com/Dayopt/dayopt/pull/1022))
...
#### UIリファインメント ([#1017](https://github.com/Dayopt/dayopt/pull/1017))
...
#### a11y修正 ([#1022](https://github.com/Dayopt/dayopt/pull/1022))
...
#### グローバル対応修正 ([#1022](https://github.com/Dayopt/dayopt/pull/1022))
...
#### Supabase修正 ([#1022](https://github.com/Dayopt/dayopt/pull/1022))

- Security advisor警告の一括修正
- Performance advisor警告の修正

#### モバイル修正 ([#1017](https://github.com/Dayopt/dayopt/pull/1017), [#1022](https://github.com/Dayopt/dayopt/pull/1022))
...
#### その他 ([#1022](https://github.com/Dayopt/dayopt/pull/1022))
...
- **Next.jsパフォーマンス最適化** ([#1017](https://github.com/Dayopt/dayopt/pull/1017))
  - React Compiler有効化（→後に無効化、安定性のため）
  - `useTransition` によるUI応答性改善
  - リスト仮想化
- **ホットパス改善** ([#1017](https://github.com/Dayopt/dayopt/pull/1017))
  - ホットパスのlogger呼び出し削除
  - drag中のDOM queryキャッシュ化
- **`entryInspector` / `tourOrchestrator` をdynamic importに変更** ([#1017](https://github.com/Dayopt/dayopt/pull/1017))
- **統計関数のWHERE句をインデックス活用可能に最適化** ([#1022](https://github.com/Dayopt/dayopt/pull/1022))

### 🔒 セキュリティ (Security)

- Supabase Security advisor警告の一括修正 ([#1022](https://github.com/Dayopt/dayopt/pull/1022))
...
- **knip dead code検出をCIに組み込み** ([#1017](https://github.com/Dayopt/dayopt/pull/1017))
- **i18n整合性チェック（`lint:i18n`）をCIに追加** ([#1017](https://github.com/Dayopt/dayopt/pull/1017))
- **未使用依存削除** ([#1017](https://github.com/Dayopt/dayopt/pull/1017))
- **E2Eテスト追加** — モバイル設定・ボトムナビゲーション ([#1017](https://github.com/Dayopt/dayopt/pull/1017))
- **ユニットテスト追加** — history・onboarding・palette（48テスト） ([#1017](https://github.com/Dayopt/dayopt/pull/1017))
- **AI feature の deep import解消** + 重複テスト削除 ([#1017](https://github.com/Dayopt/dayopt/pull/1017))
...
| PR                                                  | タイトル                                                         | 概要                                                                         |
| --------------------------------------------------- | ---------------------------------------------------------------- | ---------------------------------------------------------------------------- |
| [#1017](https://github.com/Dayopt/dayopt/pull/1017) | feat: モバイルUI刷新 + カレンダーリファクタリング + タグアイコン | モバイル体験の全面刷新、カレンダー内部統一、タグアイコン、パフォーマンス改善 |
| [#1022](https://github.com/Dayopt/dayopt/pull/1022) | v0.23.0                                                          | Chronotypeリデザイン、トークン刷新、TZ修正、メールi18n、通知強化、用語統一   |

---

**Full Changelog**: https://github.com/Dayopt/dayopt/compare/v0.22.0...v0.23.0
