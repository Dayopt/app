...
.github/
  ...
  workflows/
    ...
    supabase-migration.yml    # Staging マイグレーション
...
| `supabase-migration.yml` | `contents: read`  | コード読み取りのみ   |
...
| `SUPABASE_ACCESS_TOKEN`         | Supabase CLI 認証 | integration, supabase-migration |
| `STAGING_DB_PASSWORD`           | Staging DB        | supabase-migration              |
