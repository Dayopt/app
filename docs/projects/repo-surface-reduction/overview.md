...
**2026-08、`.claude/skills/gardening/SKILL.md` 自動パート step 1（journal 下書き）が §1-4 のコマンドを参照する正本として本 doc を指すようになった**（epic #2165 完了条件 5）。§1-4 の見出し番号や数え方コマンドを変更する時は、gardening 側の参照文言が指す先が壊れていないか確認する。
