...
> 再生成で更新すること。
>
> 集計: public スキーマの policy 38 件 / RLS 対象テーブル 13 件 / GRANT 96 件 / Realtime publication 0 件。
...
| view        | public.logs                                                                                                                                                                                                                                      | authenticated       | DELETE, INSERT, SELECT, UPDATE |
| view        | public.logs                                                                                                                                                                                                                                      | service_role        | DELETE, INSERT, SELECT, UPDATE |
