...
| Anthropic（Claude）      | 開発エージェント（Claude Code）、月次ガーデニング Routine                                         | `CLAUDE.md`、`.claude/`                                                                             | claude.ai / Anthropic console             |
| OpenAI（ChatGPT）        | 情報収集（Codex クラウド PR レビューは 2026-08-13 時点で運用停止、規則は `AGENTS.md` に凍結保存） | `AGENTS.md`                                                                                         | ChatGPT settings                          |
