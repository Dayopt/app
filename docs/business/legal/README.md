...
例: [ADR-008 cookie consent banner](../../decisions/007-cookie-consent-banner.md)、[ADR-009 cookie consent required](../../decisions/008-cookie-consent-required.md) は過去の cookie 同意まわりの意思決定記録（このディレクトリ新設以前のもの）。
