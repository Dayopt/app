...
import { TimeblockMicroInsight } from './TimeblockMicroInsight';
 ...
 */
const meta = {
  title: 'Product/Features/Review/Shared/TimeblockMicroInsight',
  component: TimeblockMicroInsight,
...
} satisfies Meta<typeof TimeblockMicroInsight>;
    ...
    <div className="flex flex-col items-start gap-6">
      ...
      <div>
        ...
        <div className="bg-card max-w-sm rounded-lg p-4">
          ...
          <div className="mt-2">
            <TimeblockMicroInsight insight={null} />
          </div>
          <div className="bg-muted mt-4 rounded-2xl p-4">
            <span className="text-muted-foreground text-xs">10:00 - 12:00</span>
          </div>
