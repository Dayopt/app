...
export const AllPatterns: Story = {
  ...
  render: () => (
    <div className="flex flex-col items-start gap-6">
      <div>
        <p className="text-muted-foreground mb-4 text-xs">Mixed（警告＋情報の混在）</p>
        <RuleInsightList insights={MOCK_INSIGHTS} />
      </div>
      <div>
        <p className="text-muted-foreground mb-4 text-xs">WarningsOnly（警告のみ）</p>
        <RuleInsightList
          insights={[
            {
              metricId: 'contextSwitches',
      ...
      <div>
        <p className="text-muted-foreground mb-4 text-xs">Empty（空・問題なし）</p>
