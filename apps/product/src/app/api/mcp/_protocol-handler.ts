 ...
 *
 * SDK 1.29 の `WebStandardStreamableHTTPServerTransport` を stateless mode で
 * request ごとに立てる。SDK 2.0 の `createMcpHandler` / `isLegacyRequest` は使わない
 * （2.0 移行は別 track。ここは現行 transport 1 本に縮退させている）。
 */
