...
| 4    | [Packages Overview](?path=/docs/architecture-packages-overview--docs) | monorepo packages の責務境界と token 移行方針  |
| 5    | [Data Flow](?path=/docs/docs-architecture-data-flow--docs)            | UI → tRPC → Supabase のデータの流れ            |
| 6    | [Common Pitfalls](?path=/docs/docs-guides-common-pitfalls--docs)      | よくある間違いと正しいパターン                 |
