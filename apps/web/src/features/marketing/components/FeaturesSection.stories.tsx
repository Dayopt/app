/**
 * Features セクション（Landing）の Storybook Story。
 *
...
const meta = {
  title: 'Web/Sections/Landing/Features',
...
export const Ja: Story = {
  render: () => <FeaturesSection locale="ja" />,
};

/** 英語ロケール。 */
export const En: Story = {
  render: () => <FeaturesSection locale="en" />,
};
