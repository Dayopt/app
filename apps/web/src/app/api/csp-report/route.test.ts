...
describe('/api/csp-report', () => {
  ...
  it.each(['geist.woff2', 'geist_mono.woff2'])(
    'accepts Vercel Toolbar font %s without sending it to Sentry',
    async (fontPath) => {
      const report = {
        ...validReport,
        'csp-report': {
          ...
          'blocked-uri': `https://vercel.live/${fontPath}`,
  ...
  it.each(['geist.woff2', 'geist_mono.woff2'])(
    'accepts Vercel Toolbar font %s when source-file is omitted',
    async (fontPath) => {
      const report = {
        ...validReport,
        'csp-report': {
          ...validReport['csp-report'],
          'document-uri': 'https://dayopt.app/ja',
          'violated-directive': "font-src 'self'",
          'blocked-uri': `https://vercel.live/${fontPath}`,
  ...
  it.each([
    ...
    ['font-src', 'https://vercel.live/another-font.woff2', undefined],
    ['font-src', 'https://vercel.live/another-font.woff2', 'https://vercel.live/instrument.js'],
    ['font-src', 'https://vercel.live/geist.woff2', 'not-a-url'],
    ['font-src', 'https://vercel.live/geist.woff2', ''],
    ['script-src', 'https://vercel.live/geist.woff2', 'https://vercel.live/instrument.js'],
    [
      'font-src',
      'https://vercel.live.attacker.example/geist.woff2',
      'https://vercel.live/instrument.js',
    ],
    [
      'font-src',
      'https://vercel.live/geist.woff2',
      'https://vercel.live.attacker.example/instrument.js',
    ],
  ])(
