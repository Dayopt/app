    ...
    sections: {
      ...
      categories: {
        ...
        analytics: {
          ...
          description:
            'These optional cookies and similar browser technologies help us diagnose browser errors and understand performance and usage. Browser Sentry, Vercel Analytics, and Speed Insights start only after analytics consent. Session Replay is disabled.',
          examples: 'Browser errors, page views, and performance metrics',
        },
        preference: {
      ...
      thirdParty: {
        ...
        sentry:
          'Sentry — Sanitized Production server and edge error monitoring runs regardless of analytics consent. Browser Sentry runs only after analytics consent. Session Replay is disabled because the current SDK cannot guarantee removal of URL query strings from Replay payloads. Product and Website data are kept in separate Sentry projects. Sentry events exclude request bodies, email addresses, URL query strings, cookies, and authorization credentials.',
        turnstile:
