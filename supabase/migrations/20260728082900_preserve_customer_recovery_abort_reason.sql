-- Preserve whether an active Billing claim owned a Customer recovery attempt
-- before deleting that temporary row during account-deletion begin.
...
COMMENT ON FUNCTION
  ...
  'Blocks live Customer POST recovery, terminalizes abortable Billing work with its exact phase, and redacts redirect capabilities during generic deletion begin.';
