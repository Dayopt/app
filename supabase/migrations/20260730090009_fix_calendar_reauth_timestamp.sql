-- COALESCE is SQL syntax, not a pg_catalog function. Replace the conditional
-- reauthorization command without rewriting the applied migration.
...
CREATE OR REPLACE FUNCTION public.mark_calendar_connection_reauth_command_v1(
  p_user_id UUID,
