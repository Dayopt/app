-- PostgreSQL cannot infer the SMALLINT/TEXT overloads of the private replay
-- helper from bare SQL literals inside PL/pgSQL. Keep the public signature and
-- replace only its body with explicit typed constants.
