-- Bound confirm-day lock scope. 26 hours covers local calendar days across
-- daylight-saving transitions without permitting arbitrary bulk ranges.
...
) IS 'Atomically records eligible Plans within a bounded day range after lock-time revalidation; service role only.';
