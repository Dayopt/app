...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      'text-muted-foreground data-[state=active]:text-foreground hover:bg-state-hover ring-offset-background focus-visible:ring-ring data-[state=active]:after:bg-foreground relative inline-flex items-center justify-center gap-2 rounded-lg px-2 py-1 text-sm font-normal whitespace-nowrap transition-all after:absolute after:inset-x-2 after:bottom-0 after:h-0.5 after:rounded-full after:bg-transparent after:transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-transparent data-[state=active]:shadow-none',
      className,
    )}
    {...props}
  />
