...
| 層  | タイミング | 内容                                                                                                                                                     | 実装                                                                           |
| --- | ---------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| 1   | draft push | Docs Guard のみ（Static Checks / Unit Tests は 2026-08-26 に撤去、#2415）。Actions 外では Vercel Preview build が draft でも走る                         | `.github/workflows/docs-guard.yml`                                             |
| 2   | ready      | Static Checks / Unit Tests（Impact gate による docs-only skip 込み）。Docs Guard は層 1 の結果が残る（`ready_for_review` を types に持たず再発火しない） | `.github/workflows/ci.yml`                                                     |
