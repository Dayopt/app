...
- **ルール 1 と P1 インフレ抑止**: 「壊れる筋書き」は本番でユーザー影響・データ破壊・認可漏れ・誤課金を指す。この diff 以前から壊れている既存問題や、本番挙動を壊さない記述不足（runbook の説明不足など）は P1 に計上しない。P1/P2/P3 の定義そのものの生きた正本は `.claude/skills/pr-cross-review/SKILL.md` 手順 4 で、本節では複製しない
