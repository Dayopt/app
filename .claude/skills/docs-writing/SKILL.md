...
- アーキテクチャ意思決定が確定し、ADR を書く時（技術判断・プロダクト判断ともに `docs/log/decisions/NNN-*.md`（正本）＋ `docs/log/decisions/index.md` 更新。技術 ADR は Storybook MDX から docs/ へ抽出済み、2026-07-02 に docs/log/decisions/ へ合流）
...
├─ なぜこの方法を選んだか（技術判断） → 技術 ADR（docs/log/decisions/NNN-*.md、正本。docs/log/decisions/index.md も更新）
├─ なぜこの方法を選んだか（プロダクト判断） → プロダクト判断ログ（docs/log/decisions/NNN-*.md）
