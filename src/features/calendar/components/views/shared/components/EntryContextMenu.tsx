...
export const EventContextMenu = ({
  ...
  return (
    <div
      ...
      className="bg-card text-card-foreground border-border animate-in fade-in-0 zoom-in-95 z-context-menu surface-raised fixed min-w-[12rem] rounded-lg border p-1 motion-reduce:animate-none"
      style={{
