                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      !isToday && !isSelected && 'hover:bg-state-hover hover:rounded-2xl',
                      isToday && 'bg-primary text-primary-foreground rounded-2xl font-bold',
                      isSelected && !isToday && 'bg-state-hover text-foreground rounded-2xl',
                    )}
                  >
                    {format(date, 'd')}
                  </button>
