                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      !isToday && !isSelected && 'hover:bg-state-hover hover:rounded-xl',
                      isToday && 'bg-primary text-primary-foreground rounded-xl font-bold',
                      isSelected && !isToday && 'bg-state-hover text-foreground rounded-xl',
                    )}
                  >
                    {format(date, 'd')}
                  </button>
