...
export function TourPreChoice({ onStart, onSkip }: TourPreChoiceProps) {
  ...
  return (
    <div className="z-tour fixed inset-0 flex items-center justify-center">
      <div
        className="bg-card animate-in fade-in zoom-in-95 mx-4 flex w-full max-w-80 flex-col items-center gap-4 rounded-xl p-8 text-center shadow-md duration-150"
        role="dialog"
