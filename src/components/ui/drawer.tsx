...
function DrawerOverlay({
  ...
  return (
    <DrawerPrimitive.Overlay
      ...
      className={cn(
        'data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 z-sheet fixed inset-0 bg-black/50 data-[state=closed]:pointer-events-none',
        className,
      )}
      {...props}
    />
