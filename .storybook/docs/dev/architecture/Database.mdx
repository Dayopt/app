...
<Meta title="Architecture/Supabase/Database" />
...
| テーブル             | 役割             | 主要カラム                                              |
| -------------------- | ---------------- | ------------------------------------------------------- |
| **entry_activities** | エントリ変更履歴 | entry_id, action_type, field_name, old_value, new_value |
...
| `cleanup-entry-activities` | 毎日 03:30 UTC | 365日            | entry_activities |
